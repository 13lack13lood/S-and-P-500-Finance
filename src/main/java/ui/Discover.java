...
/**
 * 
 * The class for the Discover menu that creates all the UI elements of the page
 *
 */
public class Discover extends UserInterface {
	 ...
	 * @throws IOException
	 */
	public Discover(Stage stage, StockDataHandler stockHandler) throws FileNotFoundException, IOException {
		super(stage);

		stocks = stockHandler.getStocks();
